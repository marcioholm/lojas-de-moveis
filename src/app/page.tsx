    ...
    <div className="min-h-screen bg-[var(--bg)] font-sans text-[var(--text-primary)] selection:bg-[var(--accent)] selection:text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/login" className="bg-[var(--cta)] text-white px-6 py-2.5 rounded-lg font-bold shadow-md hover:bg-[var(--cta-hover)] hover:-translate-y-0.5 transition-all">
                Testar Grátis
              </Link>
            </div>
        ...
        {mobileMenuOpen && (
          <div className="md:hidden bg-white border-t border-gray-100 px-4 pt-2 pb-6 space-y-2 shadow-xl absolute w-full">
            ...
            <div className="pt-4 flex flex-col gap-3 px-3">
              ...
              <Link href="/login" className="w-full text-center py-3 bg-[var(--cta)] text-white rounded-lg font-bold">Testar Grátis</Link>
            </div>
          </div>
        )}
      </nav>
      ...
      <section className="pt-40 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          <Link href="/login" className="w-full sm:w-auto bg-[var(--cta)] text-white px-8 py-4 rounded-xl font-bold text-lg shadow-lg shadow-[var(--cta)]/30 hover:bg-[var(--cta-hover)] hover:-translate-y-1 transition-all">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-center max-w-6xl mx-auto">
            ...
            <div className="bg-white p-8 rounded-3xl border border-[var(--border-light)] shadow-sm relative">
              ...
              <Link href="/login" className="block w-full py-4 text-center rounded-xl font-bold text-[var(--primary)] bg-gray-50 border border-gray-200 hover:bg-gray-100 transition-colors">
                Começar Vitrine
              </Link>
            </div>
            ...
            <div className="bg-[var(--primary)] p-10 rounded-3xl shadow-2xl relative transform lg:scale-105 z-10 border-2 border-[var(--accent)]">
              ...
              <Link href="/login" className="block w-full py-4 text-center rounded-xl font-bold text-white bg-[var(--cta)] hover:bg-[var(--cta-hover)] shadow-lg hover:-translate-y-0.5 transition-all">
            ...
            <div className="bg-white p-8 rounded-3xl border border-[var(--border-light)] shadow-sm relative">
              ...
              <Link href="/login" className="block w-full py-4 text-center rounded-xl font-bold text-white bg-[var(--primary)] hover:bg-[var(--primary-hover)] shadow-md transition-colors">
                Assinar o Completo
              </Link>
            </div>
          </div>
      ...
      <section className="py-24 bg-[var(--primary)] text-center px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <Link href="/login" className="inline-block bg-[var(--cta)] text-white px-10 py-5 rounded-xl font-bold text-xl shadow-2xl hover:bg-[var(--cta-hover)] hover:-translate-y-1 transition-all">
